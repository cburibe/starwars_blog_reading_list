...
import starwarslogo from "../../img/starwar_logo.png";
					...
					<ul className="navbar-nav">
						<li className="nav-item">
							<Link to="/Characters" className="nav-link text-white">
								<span className="navbar-brand mb-0 h2">Characters</span>
							</Link>
						</li>
						<li className="nav-item">
							<Link to="/planets" className="nav-link text-white">
								<span className="navbar-brand mb-0 h2">Planets</span>
							</Link>
						</li>
						<li className="nav-item">
							<Link to="/" className="nav-link text-white">
								<span className="navbar-brand mb-0 h2">Starships</span>
							</Link>
						</li>
